...
predict(fit2, newdata = new_data, interval = 'prediction', level = 0.95)
```
```{r}
predict(fit2, newdata = new_data2, interval = 'confidence', level = 0.95)[2]^2
predict(fit2, newdata = new_data2, interval = 'confidence', level = 0.95)[3]^2
```
With 95% confidence, the final score of a student aged 22 is between 7.778433 and 10.43402.
